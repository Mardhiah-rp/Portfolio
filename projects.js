...
const PROJECTS = [
    {
        id: 1,
        title: "WildAware",
        category: "web", // "mobile" | "web" | "design"
        ...
        overview: "WildAware is an interactive wildlife awareness website designed to educate users about animals through visually engaging card-based content.\n" +
...

    {
        ...
        overview: "Mars Pizza Co. is a modern pizza shop web application built using React.The website simulates a real online food ordering experience, allowing users to browse a pizza menu, add items to a cart, apply promo codes, and complete a checkout flow. \n" +
...

    {
        ...
        overview: "Marsonian’s Cards is a web-based card collection management application built using Node.js and Express." +
...

    {
        ...
        overview: "The Wildlife Animal Mobile App is a mobile application developed using React Native, designed to educate users about different animal species through an interactive and engaging experience." +
        ...
        features: ["View list of animals retrieved from backend API", "Interactive Quiz Feature to test user knowledge and get immediate feedback and score tally",
            "Designed specifically for mobile interaction", "Input validation and User Feedback"],
...

    {
        ...
        overview: "Bucket List and Memory Tracker is a multi-screen mobile application developed using React Native and Expo." +
        ...
        features: ["Create, view and manage list of people and store data in AsyncStorage",
...

    {
        ...
        overview: "The app allows users to view a bakery menu organised into clear categories such as Cakes and Bread & Cookies. Each menu item is displayed with an image, description, and price information." +
        ...
        features: ["Create, view and manage menu of items",
...

    {
        ...
        overview: "This is a ui/ux design of a educational app called Learn@RP. It includes adding courses, keeping the courses in a wishlist" +
        "and accessing the module details and lesson plans. There are videos displayed to help students study linkedin styled.",
        tools: ["Figma"],
        features: ["Login and Sign Up, toggle to remember user",
        "View courses and favourite course and modules","View modules in courses and lesson detail plans",
        "Leave comments and reviews for lesson modules."],
        links: { live: "", github: "", figma: "https://www.figma.com/design/zWgu5RAS19nr9H957526vI/Mardhiah-24049647-Learn-RP-App?node-id=35-130&t=KE88pBoFVp1L2OYk-1" },
    },
